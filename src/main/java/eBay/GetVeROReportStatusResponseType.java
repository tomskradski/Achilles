...
@XmlType(name = "GetVeROReportStatusResponseType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "paginationResult",
    "hasMoreItems",
    "itemsPerPage",
    "pageNumber",
    ...
    extends AbstractResponseType
{
    ...
    @XmlElement(name = "ReportedItemDetails", namespace = "urn:ebay:apis:eBLBaseComponents")
