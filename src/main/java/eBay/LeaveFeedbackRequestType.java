...
@XmlType(name = "LeaveFeedbackRequestType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "itemID",
    "commentText",
    "commentType",
    "transactionID",
    ...
    extends AbstractRequestType
{
    ...
    @XmlElement(name = "SellerItemRatingDetailArray", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "ItemArrivedWithinEDDType", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "token")
    protected ItemArrivedWithinEDDCodeType itemArrivedWithinEDDType;
    @XmlElement(name = "ItemDeliveredWithinEDD", namespace = "urn:ebay:apis:eBLBaseComponents")
