 ...
 * 
 */
@XmlType(name = "PickupMethodCodeType", namespace = "urn:ebay:apis:eBLBaseComponents")
@XmlEnum
public enum PickupMethodCodeType {
     ...
     * 						<br/><br/>
     * 						<span class="tablenote">
     * 						<strong>Note:</strong> A merchant must be eligible for the "Click and Collect" feature to list an item that is eligible for "Click and Collect". At this time, the "Click and Collect" feature is only available to large merchants on the eBay UK (site ID - 3) and eBay Australia (Site ID - 15) sites. 
     * 					
     * 
     */
