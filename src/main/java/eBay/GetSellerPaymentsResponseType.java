 ...
 * 				<br/><br/>
 * 				Each payment is for one transaction for one item in one order. An order can contain transactions for multiple items from multiple sellers, but this call only retrieves payments that are relevant to one seller.
 * 				<br/><br/>
 ...
 * 				<br/><br/>
 * 				For most sellers, each month contains two pay periods: One from the 1st to the 15th of the month, and one from the 16th to the last day of the month. Payments are submitted to the seller's financial institution a certain number of days after the current pay period ends (see the Half.com online help for details).
 * 			
 * 
...
@XmlType(name = "GetSellerPaymentsResponseType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "paginationResult",
    "hasMorePayments",
    "sellerPayment",
    "paymentsPerPage",
    ...
    extends AbstractResponseType
{
    ...
    @XmlElement(name = "HasMorePayments", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean hasMorePayments;
    @XmlElement(name = "SellerPayment", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected List<SellerPaymentType> sellerPayment;
    @XmlElement(name = "PaymentsPerPage", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer paymentsPerPage;
    @XmlElement(name = "PageNumber", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer pageNumber;
    @XmlElement(name = "ReturnedPaymentCountActual", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    /**
     * Gets the value of the sellerPayment property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the sellerPayment property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSellerPayment().add(newItem);
     * </pre>
     * 
     * 
     * <p>
