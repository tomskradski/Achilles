 ...
 * 				<br/><br/>
 * 				Each payment is for one order line item in one order. An order can contain order line items for multiple items from multiple sellers, but this call only retrieves payments that are relevant to one seller. The financial value of a payment is typically based on an amount that a buyer paid to Half.com for an order line item, with adjustments for shipping costs and Half.com's commission.
 * 				<br/><br/>
 ...
 * 				<br/><br/>
 * 				When a buyer makes a purchase and an order is created, Half.com creates a payment for the seller and marks it as <b>Pending</b> in the seller's Half.com account. Within a certain number of days after the pay period ends, Half.com settles payments for that period and marks each completed payment as Paid.
 * 				<br/><br/>
 * 				See the Half.com Web site online help for more information about how payments are managed.
 * 			
 * 
...
@XmlType(name = "GetSellerPaymentsRequestType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "paymentStatus",
    "paymentTimeFrom",
    "paymentTimeTo",
    "pagination"
    ...
    extends AbstractRequestType
{
    ...
    @XmlElement(name = "PaymentTimeFrom", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar paymentTimeFrom;
    @XmlElement(name = "PaymentTimeTo", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar paymentTimeTo;
     ...
     *     
     */
    public XMLGregorianCalendar getPaymentTimeFrom() {
     ...
     *     
     */
    public void setPaymentTimeFrom(XMLGregorianCalendar value) {
     ...
     *     
     */
    public XMLGregorianCalendar getPaymentTimeTo() {
     ...
     *     
     */
    public void setPaymentTimeTo(XMLGregorianCalendar value) {
