...
@XmlType(name = "DeleteSellingManagerTemplateAutomationRuleRequestType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "saleTemplateID",
    ...
    extends AbstractRequestType
{
    ...
    @XmlElement(name = "DeleteAutomatedListingRule", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean deleteAutomatedListingRule;
    @XmlElement(name = "DeleteAutomatedRelistingRule", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean deleteAutomatedRelistingRule;
    @XmlElement(name = "DeleteAutomatedSecondChanceOfferRule", namespace = "urn:ebay:apis:eBLBaseComponents")
