...
@XmlType(name = "GetVeROReportStatusRequestType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "veROReportPacketID",
    "itemID",
    ...
    extends AbstractRequestType
{
    ...
    @XmlElement(name = "IncludeReportedItemDetails", namespace = "urn:ebay:apis:eBLBaseComponents")
