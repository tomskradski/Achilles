...
@XmlType(name = "GetStoreOptionsResponseType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "basicThemeArray",
    "advancedThemeArray",
    "logoArray",
    "subscriptionArray",
    ...
    extends AbstractResponseType
{
    ...
    @XmlElement(name = "BasicThemeArray", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected StoreThemeArrayType basicThemeArray;
    @XmlElement(name = "AdvancedThemeArray", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected StoreThemeArrayType advancedThemeArray;
    @XmlElement(name = "LogoArray", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected StoreLogoArrayType logoArray;
    @XmlElement(name = "SubscriptionArray", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected StoreSubscriptionArrayType subscriptionArray;
    @XmlElement(name = "MaxCategories", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer maxCategories;
    @XmlElement(name = "MaxCategoryLevels", namespace = "urn:ebay:apis:eBLBaseComponents")
