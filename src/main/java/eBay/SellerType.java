...
public class SellerType {
    ...
    @XmlElement(name = "PaisaPayStatus", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "MerchandizingPref", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "token")
    ...
    @XmlElement(name = "SellerGuaranteeLevel", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "token")
    protected SellerGuaranteeLevelCodeType sellerGuaranteeLevel;
    @XmlElement(name = "SellerLevel", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "token")
    ...
    @XmlElement(name = "RegisteredBusinessSeller", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean registeredBusinessSeller;
    @XmlElement(name = "StoreSite", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "token")
    ...
    @XmlElement(name = "ProStoresPreference", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected ProStoresCheckoutPreferenceType proStoresPreference;
    @XmlElement(name = "CharityRegistered", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean charityRegistered;
    @XmlElement(name = "SafePaymentExempt", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean safePaymentExempt;
    @XmlElement(name = "PaisaPayEscrowEMIStatus", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer paisaPayEscrowEMIStatus;
    @XmlElement(name = "CharityAffiliationDetails", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "IntegratedMerchantCreditCardInfo", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected IntegratedMerchantCreditCardInfoType integratedMerchantCreditCardInfo;
    @XmlElement(name = "FeatureEligibility", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected FeatureEligibilityType featureEligibility;
    @XmlElement(name = "TopRatedSeller", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean topRatedSeller;
    @XmlElement(name = "TopRatedSellerDetails", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected TopRatedSellerDetailsType topRatedSellerDetails;
    @XmlElement(name = "RecoupmentPolicyConsent", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "SellereBayPaymentProcessConsent", namespace = "urn:ebay:apis:eBLBaseComponents")
