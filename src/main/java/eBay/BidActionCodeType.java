 ...
 * 
 */
@XmlType(name = "BidActionCodeType", namespace = "urn:ebay:apis:eBLBaseComponents")
@XmlEnum
public enum BidActionCodeType {
    ...
    /**
     * 
     * 						This value is used in a <b>PlaceOffer</b> call if the buyer wants to purchase a fixed-price item or purchase an auction item enabled with the Buy It Now feature.  The <b>GetAllBidders</b> call will return this value as well if the buyer purchased the item. For items requiring immediate payment, the <b>PlaceOffer</b> call cannot be used for purchase.
     * 					
     * 
     */
