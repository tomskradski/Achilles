...
@XmlType(name = "GetFeedbackResponseType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "feedbackDetailArray",
    ...
    extends AbstractResponseType
{
    ...
    @XmlElement(name = "FeedbackDetailArray", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected FeedbackDetailArrayType feedbackDetailArray;
    @XmlElement(name = "FeedbackDetailItemTotal", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer feedbackDetailItemTotal;
    @XmlElement(name = "FeedbackSummary", namespace = "urn:ebay:apis:eBLBaseComponents")
