...
@XmlType(name = "RespondToBestOfferResponseType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "respondToBestOffer"
})
    ...
    extends AbstractResponseType
{
    ...
    @XmlElement(name = "RespondToBestOffer", namespace = "urn:ebay:apis:eBLBaseComponents")
