...
@XmlType(name = "ContactHoursDetailsType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "timeZoneID",
    "hours1Days",
    "hours1AnyTime",
    "hours1From",
...
public class ContactHoursDetailsType {
    ...
    @XmlElement(name = "Hours1Days", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "token")
    protected DaysCodeType hours1Days;
    @XmlElement(name = "Hours1AnyTime", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean hours1AnyTime;
    @XmlElement(name = "Hours1From", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "time")
    protected XMLGregorianCalendar hours1From;
    @XmlElement(name = "Hours1To", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "time")
    protected XMLGregorianCalendar hours1To;
    @XmlElement(name = "Hours2Days", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "token")
    protected DaysCodeType hours2Days;
    @XmlElement(name = "Hours2AnyTime", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean hours2AnyTime;
    @XmlElement(name = "Hours2From", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "time")
    protected XMLGregorianCalendar hours2From;
    @XmlElement(name = "Hours2To", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "time")
