...
@XmlType(name = "ReviseSellingManagerSaleRecordRequestType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "itemID",
    "transactionID",
    "orderID",
    ...
    extends AbstractRequestType
{
    ...
    @XmlElement(name = "SellingManagerSoldOrder", namespace = "urn:ebay:apis:eBLBaseComponents")
