...
@XmlType(name = "BuyingGuideDetailsType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "buyingGuide",
    "buyingGuideHub"
})
public class BuyingGuideDetailsType {

    @XmlElement(name = "BuyingGuide", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected List<BuyingGuideType> buyingGuide;
    @XmlElement(name = "BuyingGuideHub", namespace = "urn:ebay:apis:eBLBaseComponents")
