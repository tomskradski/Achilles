...
@XmlType(name = "SetSellingManagerFeedbackOptionsRequestType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    ...
    extends AbstractRequestType
{
    ...
    @XmlElement(name = "AutomatedLeaveFeedbackEvent", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "token")
    protected AutomatedLeaveFeedbackEventCodeType automatedLeaveFeedbackEvent;
    @XmlElement(name = "StoredComments", namespace = "urn:ebay:apis:eBLBaseComponents")
