...
@XmlType(name = "ValidateChallengeInputRequestType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "challengeToken",
    "userInput",
    "keepTokenValid"
})
    ...
    extends AbstractRequestType
{
    ...
    @XmlElement(name = "UserInput", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected String userInput;
    @XmlElement(name = "KeepTokenValid", namespace = "urn:ebay:apis:eBLBaseComponents")
