...
@XmlType(name = "GroupValidationRulesType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "minRequired"
})
public class GroupValidationRulesType {

    @XmlElement(name = "MinRequired", namespace = "urn:ebay:apis:eBLBaseComponents")
