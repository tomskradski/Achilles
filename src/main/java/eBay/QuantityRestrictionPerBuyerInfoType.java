...
@XmlType(name = "QuantityRestrictionPerBuyerInfoType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "maximumQuantity"
})
public class QuantityRestrictionPerBuyerInfoType {

    @XmlElement(name = "MaximumQuantity", namespace = "urn:ebay:apis:eBLBaseComponents")
