...
@XmlType(name = "NotificationMessageType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "messageBody",
    "eias"
})
    ...
    extends AbstractResponseType
{
    ...
    @XmlElement(name = "MessageBody", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected String messageBody;
    @XmlElement(name = "EIAS", namespace = "urn:ebay:apis:eBLBaseComponents")
