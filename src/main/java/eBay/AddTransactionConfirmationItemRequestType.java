...
@XmlType(name = "AddTransactionConfirmationItemRequestType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "recipientUserID",
    ...
    extends AbstractRequestType
{
    ...
    @XmlElement(name = "RecipientUserID", namespace = "urn:ebay:apis:eBLBaseComponents", required = true)
    protected String recipientUserID;
    @XmlElement(name = "VerifyEligibilityOnly", namespace = "urn:ebay:apis:eBLBaseComponents", required = true)
    protected String verifyEligibilityOnly;
    @XmlElement(name = "RecipientPostalCode", namespace = "urn:ebay:apis:eBLBaseComponents", required = true)
    protected String recipientPostalCode;
    @XmlElement(name = "RecipientRelationType", namespace = "urn:ebay:apis:eBLBaseComponents", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
    protected String recipientRelationType;
    @XmlElement(name = "NegotiatedPrice", namespace = "urn:ebay:apis:eBLBaseComponents", required = true)
    protected AmountType negotiatedPrice;
    @XmlElement(name = "ListingDuration", namespace = "urn:ebay:apis:eBLBaseComponents", required = true)
    @XmlSchemaType(name = "token")
    ...
    @XmlElement(name = "Comments", namespace = "urn:ebay:apis:eBLBaseComponents", required = true)
