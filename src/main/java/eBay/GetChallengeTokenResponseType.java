...
@XmlType(name = "GetChallengeTokenResponseType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "challengeToken",
    "imageChallengeURL",
    "audioChallengeURL"
})
    ...
    extends AbstractResponseType
{
    ...
    @XmlElement(name = "ChallengeToken", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected String challengeToken;
    @XmlElement(name = "ImageChallengeURL", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected String imageChallengeURL;
    @XmlElement(name = "AudioChallengeURL", namespace = "urn:ebay:apis:eBLBaseComponents")
