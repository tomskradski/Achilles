...
@XmlType(name = "SetPromotionalSaleListingsRequestType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "promotionalSaleID",
    "action",
    ...
    extends AbstractRequestType
{
    ...
    @XmlElement(name = "AllFixedPriceItems", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean allFixedPriceItems;
    @XmlElement(name = "AllStoreInventoryItems", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean allStoreInventoryItems;
    @XmlElement(name = "AllAuctionItems", namespace = "urn:ebay:apis:eBLBaseComponents")
