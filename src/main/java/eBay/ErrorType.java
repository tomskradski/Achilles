...
public class ErrorType {
    ...
    @XmlElement(name = "UserDisplayHint", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean userDisplayHint;
    @XmlElement(name = "SeverityCode", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "token")
    ...
    @XmlElement(name = "ErrorClassification", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "token")
