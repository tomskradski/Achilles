...
@XmlType(name = "StoreType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "name",
    "urlPath",
    "url",
    "subscriptionLevel",
...
public class StoreType {
    ...
    @XmlElement(name = "HeaderStyle", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "token")
    protected StoreHeaderStyleCodeType headerStyle;
    @XmlElement(name = "HomePage", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Long homePage;
    @XmlElement(name = "ItemListLayout", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "token")
    protected StoreItemListLayoutCodeType itemListLayout;
    @XmlElement(name = "ItemListSortOrder", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "token")
    protected StoreItemListSortOrderCodeType itemListSortOrder;
    @XmlElement(name = "CustomHeaderLayout", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "token")
    protected StoreCustomHeaderLayoutCodeType customHeaderLayout;
    @XmlElement(name = "CustomHeader", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected String customHeader;
    @XmlElement(name = "ExportListings", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean exportListings;
    @XmlElement(name = "CustomCategories", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected StoreCustomCategoryArrayType customCategories;
    @XmlElement(name = "CustomListingHeader", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected StoreCustomListingHeaderType customListingHeader;
    @XmlElement(name = "MerchDisplay", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "token")
    protected MerchDisplayCodeType merchDisplay;
    @XmlElement(name = "LastOpenedTime", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar lastOpenedTime;
    @XmlElement(name = "TitleWithCompatibility", namespace = "urn:ebay:apis:eBLBaseComponents")
     ...
     *     
     */
    public XMLGregorianCalendar getLastOpenedTime() {
     ...
     *     
     */
    public void setLastOpenedTime(XMLGregorianCalendar value) {
