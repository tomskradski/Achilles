...
@XmlType(name = "SaveItemToSellingManagerTemplateResponseType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "templateID"
})
    ...
    extends AbstractResponseType
{
    ...
    @XmlElement(name = "TemplateID", namespace = "urn:ebay:apis:eBLBaseComponents")
