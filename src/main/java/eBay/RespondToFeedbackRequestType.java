...
@XmlType(name = "RespondToFeedbackRequestType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "feedbackID",
    "itemID",
    "transactionID",
    "targetUserID",
    ...
    extends AbstractRequestType
{
    ...
    @XmlElement(name = "TargetUserID", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected String targetUserID;
    @XmlElement(name = "ResponseType", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "token")
    protected FeedbackResponseCodeType responseType;
    @XmlElement(name = "ResponseText", namespace = "urn:ebay:apis:eBLBaseComponents")
