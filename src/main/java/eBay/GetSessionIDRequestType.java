...
@XmlType(name = "GetSessionIDRequestType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "ruName"
})
    ...
    extends AbstractRequestType
{
    ...
    @XmlElement(name = "RuName", namespace = "urn:ebay:apis:eBLBaseComponents")
