...
@XmlType(name = "ExtendedProductFinderIDType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "productFinderID",
...
public class ExtendedProductFinderIDType {
    ...
    @XmlElement(name = "ProductFinderBuySide", namespace = "urn:ebay:apis:eBLBaseComponents")
