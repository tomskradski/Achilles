 ...
 *         &lt;element name="CategoryBasedAttributesPrefill" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
 *         &lt;element name="SearchDetails" type="{urn:ebay:apis:eBLBaseComponents}SearchDetailsType" minOccurs="0"/>
 *         &lt;element name="PostalCode" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="ShippingTermsInDescription" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
...
public class ItemType {
    ...
    @XmlElement(name = "AttributeArray", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected AttributeArrayType attributeArray;
    @XmlElement(name = "LookupAttributeArray", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "BiddingDetails", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected BiddingDetailsType biddingDetails;
    @XmlElement(name = "MotorsGermanySearchable", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "CategoryMappingAllowed", namespace = "urn:ebay:apis:eBLBaseComponents", defaultValue = "false")
    ...
    @XmlElement(name = "DescriptionReviseMode", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "token")
    protected DescriptionReviseModeCodeType descriptionReviseMode;
    @XmlElement(name = "Distance", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "LotSize", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "FreeAddedCategory", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "ShipToLocations", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "SellerVacationNote", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "HitCount", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Long hitCount;
    @XmlElement(name = "DisableBuyerRequirements", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "LocationDefaulted", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean locationDefaulted;
    @XmlElement(name = "UseTaxTable", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "BuyerResponsibleForShipping", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean buyerResponsibleForShipping;
    @XmlElement(name = "LimitedWarrantyEligible", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean limitedWarrantyEligible;
    @XmlElement(namespace = "urn:ebay:apis:eBLBaseComponents")
    protected String eBayNotes;
    @XmlElement(name = "QuestionCount", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "CategoryBasedAttributesPrefill", namespace = "urn:ebay:apis:eBLBaseComponents", defaultValue = "false")
    protected Boolean categoryBasedAttributesPrefill;
    @XmlElement(name = "SearchDetails", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected SearchDetailsType searchDetails;
    @XmlElement(name = "PostalCode", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected String postalCode;
    @XmlElement(name = "ShippingTermsInDescription", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "PictureDetails", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected PictureDetailsType pictureDetails;
    @XmlElement(name = "DispatchTimeMax", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "LocalListing", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean localListing;
    @XmlElement(name = "SellerContactDetails", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected AddressType sellerContactDetails;
    @XmlElement(name = "TotalQuestionCount", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Long totalQuestionCount;
    @XmlElement(name = "ProxyItem", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean proxyItem;
    @XmlElement(name = "ExtendedSellerContactDetails", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "NewLeadCount", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "GroupCategoryID", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected String groupCategoryID;
    @XmlElement(name = "ClassifiedAdPayPerLeadFee", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "ApplyBuyerProtection", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected BuyerProtectionDetailsType applyBuyerProtection;
    @XmlElement(name = "ListingSubtype2", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "token")
    protected ListingSubtypeCodeType listingSubtype2;
    @XmlElement(name = "MechanicalCheckAccepted", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean mechanicalCheckAccepted;
    @XmlElement(name = "UpdateSellerInfo", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean updateSellerInfo;
    @XmlElement(name = "UpdateReturnPolicy", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean updateReturnPolicy;
    @XmlElement(name = "ItemPolicyViolation", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected ItemPolicyViolationType itemPolicyViolation;
    @XmlElement(name = "CrossBorderTrade", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected List<String> crossBorderTrade;
    @XmlElement(name = "BusinessSellerDetails", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected BusinessSellerDetailsType businessSellerDetails;
    @XmlElement(name = "BuyerGuaranteePrice", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "ReturnPolicy", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected ReturnPolicyType returnPolicy;
    @XmlElement(name = "PaymentAllowedSite", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "token")
    ...
    @XmlElement(name = "ItemCompatibilityList", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected ItemCompatibilityListType itemCompatibilityList;
    @XmlElement(name = "ItemCompatibilityCount", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer itemCompatibilityCount;
    @XmlElement(name = "ConditionID", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer conditionID;
    @XmlElement(name = "ConditionDescription", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected String conditionDescription;
    @XmlElement(name = "ConditionDisplayName", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected String conditionDisplayName;
    @XmlElement(name = "TaxCategory", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected String taxCategory;
    @XmlElement(name = "QuantityAvailableHint", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "token")
    protected QuantityAvailableHintCodeType quantityAvailableHint;
    @XmlElement(name = "QuantityThreshold", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer quantityThreshold;
    @XmlElement(name = "DiscountPriceInfo", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected DiscountPriceInfoType discountPriceInfo;
    @XmlElement(name = "SellerProvidedTitle", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected String sellerProvidedTitle;
    @XmlElement(name = "VIN", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected String vin;
    @XmlElement(name = "VINLink", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected String vinLink;
    @XmlElement(name = "VRM", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected String vrm;
    @XmlElement(name = "VRMLink", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected String vrmLink;
    @XmlElement(name = "QuantityInfo", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected QuantityInfoType quantityInfo;
    @XmlElement(name = "SellerProfiles", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected SellerProfilesType sellerProfiles;
    @XmlElement(name = "ShippingServiceCostOverrideList", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected ShippingServiceCostOverrideListType shippingServiceCostOverrideList;
    @XmlElement(name = "ShippingOverride", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "TopRatedListing", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean topRatedListing;
    @XmlElement(name = "QuantityRestrictionPerBuyer", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected QuantityRestrictionPerBuyerInfoType quantityRestrictionPerBuyer;
    @XmlElement(name = "FloorPrice", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected AmountType floorPrice;
    @XmlElement(name = "CeilingPrice", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected AmountType ceilingPrice;
    @XmlElement(name = "IsIntermediatedShippingEligible", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean isIntermediatedShippingEligible;
    @XmlElement(name = "UnitInfo", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected UnitInfoType unitInfo;
    @XmlElement(name = "RelistParentID", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Long relistParentID;
    @XmlElement(name = "ConditionDefinition", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected String conditionDefinition;
    @XmlElement(name = "HideFromSearch", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean hideFromSearch;
    @XmlElement(name = "ReasonHideFromSearch", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "token")
    protected ReasonHideFromSearchCodeType reasonHideFromSearch;
    @XmlElement(name = "IncludeRecommendations", namespace = "urn:ebay:apis:eBLBaseComponents", defaultValue = "false")
    ...
    @XmlElement(name = "IgnoreQuantity", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean ignoreQuantity;
    @XmlElement(name = "AvailableForPickupDropOff", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "LiveAuction", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean liveAuction;
    @XmlElement(name = "DigitalGoodInfo", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    /**
     * Gets the value of the categoryBasedAttributesPrefill property.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
    ...
    /**
     * Sets the value of the categoryBasedAttributesPrefill property.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setCategoryBasedAttributesPrefill(Boolean value) {
    ...
    /**
     * Gets the value of the shippingTermsInDescription property.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
    ...
    /**
     * Sets the value of the shippingTermsInDescription property.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setShippingTermsInDescription(Boolean value) {
    ...
    /**
     * Gets the value of the crossBorderTrade property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the crossBorderTrade property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCrossBorderTrade().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     *     
     */
    public void setIncludeRecommendations(Boolean value) {
