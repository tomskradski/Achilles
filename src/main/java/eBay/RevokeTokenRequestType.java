...
@XmlType(name = "RevokeTokenRequestType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    ...
    extends AbstractRequestType
{
    ...
    @XmlElement(name = "UnsubscribeNotification", namespace = "urn:ebay:apis:eBLBaseComponents")
