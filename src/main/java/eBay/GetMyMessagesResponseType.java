...
@XmlType(name = "GetMyMessagesResponseType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "summary",
    "alerts",
    "messages"
})
    ...
    extends AbstractResponseType
{
    ...
    @XmlElement(name = "Alerts", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected MyMessagesAlertArrayType alerts;
    @XmlElement(name = "Messages", namespace = "urn:ebay:apis:eBLBaseComponents")
