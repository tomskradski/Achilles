...
@XmlType(name = "PlaceOfferRequestType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "offer",
    "itemID",
    "blockOnWarning",
    ...
    extends AbstractRequestType
{
    ...
    @XmlElement(name = "BlockOnWarning", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean blockOnWarning;
    @XmlElement(name = "AffiliateTrackingDetails", namespace = "urn:ebay:apis:eBLBaseComponents")
