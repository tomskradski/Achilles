...
@XmlType(name = "GetSellerTransactionsResponseType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "paginationResult",
    "hasMoreTransactions",
    "transactionsPerPage",
    "pageNumber",
    ...
    extends AbstractResponseType
{
    ...
    @XmlElement(name = "HasMoreTransactions", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean hasMoreTransactions;
    @XmlElement(name = "TransactionsPerPage", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer transactionsPerPage;
    @XmlElement(name = "PageNumber", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer pageNumber;
    @XmlElement(name = "ReturnedTransactionCountActual", namespace = "urn:ebay:apis:eBLBaseComponents")
