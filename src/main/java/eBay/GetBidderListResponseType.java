...
@XmlType(name = "GetBidderListResponseType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "bidder",
    "bidItemArray"
})
    ...
    extends AbstractResponseType
{
    ...
    @XmlElement(name = "Bidder", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected UserType bidder;
    @XmlElement(name = "BidItemArray", namespace = "urn:ebay:apis:eBLBaseComponents")
