...
@XmlType(name = "NonProfitSocialAddressType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "socialAddressType",
    "socialAddressId"
})
public class NonProfitSocialAddressType {

    @XmlElement(name = "SocialAddressType", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "token")
    protected SocialAddressTypeCodeType socialAddressType;
    @XmlElement(name = "SocialAddressId", namespace = "urn:ebay:apis:eBLBaseComponents")
