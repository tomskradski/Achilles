...
@XmlType(name = "DiscountProfileType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "discountProfileID",
    "discountProfileName",
...
public class DiscountProfileType {
    ...
    @XmlElement(name = "DiscountProfileID", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected String discountProfileID;
    @XmlElement(name = "DiscountProfileName", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "EachAdditionalAmountOff", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "WeightOff", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected MeasureType weightOff;
    @XmlElement(name = "MappedDiscountProfileID", namespace = "urn:ebay:apis:eBLBaseComponents")
