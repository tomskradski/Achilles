...
@XmlType(name = "DeleteSellingManagerTemplateResponseType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    ...
    extends AbstractResponseType
{
    ...
    @XmlElement(name = "DeletedSaleTemplateID", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected String deletedSaleTemplateID;
    @XmlElement(name = "DeletedSaleTemplateName", namespace = "urn:ebay:apis:eBLBaseComponents")
