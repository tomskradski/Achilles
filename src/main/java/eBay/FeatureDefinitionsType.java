...
@XmlType(name = "FeatureDefinitionsType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "listingDurations",
...
public class FeatureDefinitionsType {
    ...
    @XmlElement(name = "ListingDurations", namespace = "urn:ebay:apis:eBLBaseComponents")
