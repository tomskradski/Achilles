...
@XmlType(name = "GetItemRequestType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "itemID",
    "includeWatchCount",
    ...
    extends AbstractRequestType
{
    ...
    @XmlElement(name = "IncludeCrossPromotion", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean includeCrossPromotion;
    @XmlElement(name = "IncludeItemSpecifics", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean includeItemSpecifics;
    @XmlElement(name = "IncludeTaxTable", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean includeTaxTable;
    @XmlElement(name = "SKU", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected String sku;
    @XmlElement(name = "VariationSKU", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "IncludeItemCompatibilityList", namespace = "urn:ebay:apis:eBLBaseComponents")
