...
/**
 * 
 * 				Returns the Item ID, SKU (if any), listing recommendations (if applicable), the estimated fees for the relisted item (except the Final Value Fee, which isn't calculated until the item has sold), the start and end times of the listing, and other details.
 * 			
 * 
 * <p>Java class for RelistFixedPriceItemResponseType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="RelistFixedPriceItemResponseType">
 *   &lt;complexContent>
...
@XmlType(name = "RelistFixedPriceItemResponseType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "itemID",
    "sku",
    "fees",
    "startTime",
...
public class RelistFixedPriceItemResponseType
