...
@XmlType(name = "AddDisputeResponseRequestType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "disputeID",
    "messageText",
    "disputeActivity",
    "shippingCarrierUsed",
    ...
    extends AbstractRequestType
{
    ...
    @XmlElement(name = "DisputeActivity", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "ShipmentTrackNumber", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected String shipmentTrackNumber;
    @XmlElement(name = "ShippingTime", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar shippingTime;
     ...
     *     
     */
    public XMLGregorianCalendar getShippingTime() {
        return shippingTime;
    }
     ...
     *     
     */
    public void setShippingTime(XMLGregorianCalendar value) {
