...
/**
 * 
 * 				The base request type for the <b>GetOrderTransactions</b> call. This call retrieves detailed information about one or more orders. All recent orders can be retrieved, or the seller can search based on <b>OrderID</b> value(s), <b>ItemID</b> value(s), <b>OrderLineItemID</b> value(s), or by <b>SKU</b> value(s). The default behavior of this call is to retrieve eBay and Half.com orders, but there is a filter that will allow only one of these platforms to be selected.
 * 			
 * 
...
@XmlType(name = "GetOrderTransactionsRequestType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    ...
    extends AbstractRequestType
{
    ...
    @XmlElement(name = "ItemTransactionIDArray", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "IncludeFinalValueFees", namespace = "urn:ebay:apis:eBLBaseComponents")
