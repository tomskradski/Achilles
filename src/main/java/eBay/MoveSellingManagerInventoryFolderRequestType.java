...
@XmlType(name = "MoveSellingManagerInventoryFolderRequestType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "folderID",
    "newParentFolderID"
})
    ...
    extends AbstractRequestType
{
    ...
    @XmlElement(name = "NewParentFolderID", namespace = "urn:ebay:apis:eBLBaseComponents")
