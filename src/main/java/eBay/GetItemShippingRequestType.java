...
@XmlType(name = "GetItemShippingRequestType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "itemID",
    "quantitySold",
    ...
    extends AbstractRequestType
{
    ...
    @XmlElement(name = "DestinationPostalCode", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected String destinationPostalCode;
    @XmlElement(name = "DestinationCountryCode", namespace = "urn:ebay:apis:eBLBaseComponents")
