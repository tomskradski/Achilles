...
@XmlType(name = "SellerProfilePreferencesType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "sellerProfileOptedIn",
    "supportedSellerProfiles"
})
public class SellerProfilePreferencesType {

    @XmlElement(name = "SellerProfileOptedIn", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean sellerProfileOptedIn;
    @XmlElement(name = "SupportedSellerProfiles", namespace = "urn:ebay:apis:eBLBaseComponents")
