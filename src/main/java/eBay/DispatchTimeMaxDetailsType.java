 ...
 *         &lt;element name="ExtendedHandling" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "DispatchTimeMaxDetailsType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "dispatchTimeMax",
    "description",
    "detailVersion",
    "updateTime",
...
public class DispatchTimeMaxDetailsType {
    ...
    @XmlElement(name = "ExtendedHandling", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean extendedHandling;
    ...
    /**
     * Gets the value of the extendedHandling property.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
     *     
     */
    public Boolean isExtendedHandling() {
        return extendedHandling;
    }

    /**
     * Sets the value of the extendedHandling property.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setExtendedHandling(Boolean value) {
