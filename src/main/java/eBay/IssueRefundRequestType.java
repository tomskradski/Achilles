...
@XmlType(name = "IssueRefundRequestType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "itemID",
    "transactionID",
    "refundReason",
    "refundType",
    ...
    extends AbstractRequestType
{
    ...
    @XmlElement(name = "RefundReason", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "RefundMessage", namespace = "urn:ebay:apis:eBLBaseComponents")
