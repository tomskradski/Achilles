...
@XmlType(name = "GetUserPreferencesRequestType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    ...
    extends AbstractRequestType
{
    ...
    @XmlElement(name = "ShowBidderNoticePreferences", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected boolean showBidderNoticePreferences;
    @XmlElement(name = "ShowCombinedPaymentPreferences", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected boolean showCombinedPaymentPreferences;
    @XmlElement(name = "ShowCrossPromotionPreferences", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected boolean showCrossPromotionPreferences;
    @XmlElement(name = "ShowSellerPaymentPreferences", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected boolean showSellerPaymentPreferences;
    @XmlElement(name = "ShowEndOfAuctionEmailPreferences", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean showEndOfAuctionEmailPreferences;
    @XmlElement(name = "ShowSellerFavoriteItemPreferences", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean showSellerFavoriteItemPreferences;
    @XmlElement(name = "ShowProStoresPreferences", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean showProStoresPreferences;
    @XmlElement(name = "ShowEmailShipmentTrackingNumberPreference", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean showEmailShipmentTrackingNumberPreference;
    @XmlElement(name = "ShowRequiredShipPhoneNumberPreference", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean showRequiredShipPhoneNumberPreference;
    @XmlElement(name = "ShowSellerExcludeShipToLocationPreference", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean showSellerExcludeShipToLocationPreference;
    @XmlElement(name = "ShowUnpaidItemAssistancePreference", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean showUnpaidItemAssistancePreference;
    @XmlElement(name = "ShowPurchaseReminderEmailPreferences", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean showPurchaseReminderEmailPreferences;
    @XmlElement(name = "ShowUnpaidItemAssistanceExclusionList", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean showUnpaidItemAssistanceExclusionList;
    @XmlElement(name = "ShowSellerProfilePreferences", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected boolean showSellerProfilePreferences;
    @XmlElement(name = "ShowSellerReturnPreferences", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean showSellerReturnPreferences;
    @XmlElement(name = "ShowGlobalShippingProgramPreference", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean showGlobalShippingProgramPreference;
    @XmlElement(name = "ShowDispatchCutoffTimePreferences", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean showDispatchCutoffTimePreferences;
    @XmlElement(name = "ShowGlobalShippingProgramListingPreference", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean showGlobalShippingProgramListingPreference;
    @XmlElement(name = "ShowOverrideGSPServiceWithIntlServicePreference", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean showOverrideGSPServiceWithIntlServicePreference;
    @XmlElement(name = "ShowPickupDropoffPreferences", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean showPickupDropoffPreferences;
    @XmlElement(name = "ShowOutOfStockControlPreference", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean showOutOfStockControlPreference;
    @XmlElement(name = "ShoweBayPLUSPreference", namespace = "urn:ebay:apis:eBLBaseComponents")
