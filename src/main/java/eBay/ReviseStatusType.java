...
@XmlType(name = "ReviseStatusType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "itemRevised",
    "buyItNowAdded",
    "buyItNowLowered",
    "reserveLowered",
...
public class ReviseStatusType {
    ...
    @XmlElement(name = "ItemRevised", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected boolean itemRevised;
    @XmlElement(name = "BuyItNowAdded", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean buyItNowAdded;
    @XmlElement(name = "BuyItNowLowered", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean buyItNowLowered;
    @XmlElement(name = "ReserveLowered", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean reserveLowered;
    @XmlElement(name = "ReserveRemoved", namespace = "urn:ebay:apis:eBLBaseComponents")
