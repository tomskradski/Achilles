...
/**
 * 
 * 				Retrieves the orders for which the authenticated user is a participant, either as the buyer or the seller.&nbsp;<b>Also for Half.com</b>. The call returns all the orders that meet the request specifications. Orders older than 90 days old will not be returned.
 * 			
 * 
...
@XmlType(name = "GetOrdersRequestType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "orderIDArray",
    "createTimeFrom",
    "createTimeTo",
    "orderRole",
    ...
    extends AbstractRequestType
{
    ...
    @XmlElement(name = "OrderIDArray", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected OrderIDArrayType orderIDArray;
    @XmlElement(name = "CreateTimeFrom", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar createTimeFrom;
    @XmlElement(name = "CreateTimeTo", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar createTimeTo;
    @XmlElement(name = "OrderRole", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "SortingOrder", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "token")
