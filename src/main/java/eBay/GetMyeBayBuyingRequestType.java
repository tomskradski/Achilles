...
@XmlType(name = "GetMyeBayBuyingRequestType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "watchList",
    "bidList",
    "bestOfferList",
    "wonList",
    ...
    extends AbstractRequestType
{
    ...
    @XmlElement(name = "UserDefinedLists", namespace = "urn:ebay:apis:eBLBaseComponents")
