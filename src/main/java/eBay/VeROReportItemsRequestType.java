...
@XmlType(name = "VeROReportItemsRequestType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "rightsOwnerID",
    "reportItems"
})
    ...
    extends AbstractRequestType
{
    ...
    @XmlElement(name = "RightsOwnerID", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected String rightsOwnerID;
    @XmlElement(name = "ReportItems", namespace = "urn:ebay:apis:eBLBaseComponents")
