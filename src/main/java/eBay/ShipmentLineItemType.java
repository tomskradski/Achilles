...
@XmlType(name = "ShipmentLineItemType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "lineItem"
})
public class ShipmentLineItemType {

    @XmlElement(name = "LineItem", namespace = "urn:ebay:apis:eBLBaseComponents", required = true)
