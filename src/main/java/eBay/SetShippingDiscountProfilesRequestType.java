...
@XmlType(name = "SetShippingDiscountProfilesRequestType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "currencyID",
    "combinedDuration",
    "modifyActionCode",
    ...
    extends AbstractRequestType
{
    ...
    @XmlElement(name = "ModifyActionCode", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "token")
