...
@XmlType(name = "GetSellingManagerEmailLogRequestType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "itemID",
    "transactionID",
    "orderID",
    "emailDateRange",
    ...
    extends AbstractRequestType
{
    ...
    @XmlElement(name = "EmailDateRange", namespace = "urn:ebay:apis:eBLBaseComponents")
