...
@XmlType(name = "GetStoreRequestType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    ...
    extends AbstractRequestType
{
    ...
    @XmlElement(name = "CategoryStructureOnly", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean categoryStructureOnly;
    @XmlElement(name = "RootCategoryID", namespace = "urn:ebay:apis:eBLBaseComponents")
