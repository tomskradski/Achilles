...
@XmlType(name = "ContextSearchAssetType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "keyword",
    "category",
    "ranking"
})
public class ContextSearchAssetType {
    ...
    @XmlElement(name = "Keyword", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected String keyword;
    @XmlElement(name = "Category", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected CategoryType category;
    @XmlElement(name = "Ranking", namespace = "urn:ebay:apis:eBLBaseComponents")
