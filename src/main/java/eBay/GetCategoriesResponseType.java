...
@XmlType(name = "GetCategoriesResponseType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "categoryArray",
    "categoryCount",
    "updateTime",
    "categoryVersion",
    ...
    extends AbstractResponseType
{
    ...
    @XmlElement(name = "CategoryArray", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected CategoryArrayType categoryArray;
    @XmlElement(name = "CategoryCount", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "ReservePriceAllowed", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "ReduceReserveAllowed", namespace = "urn:ebay:apis:eBLBaseComponents")
