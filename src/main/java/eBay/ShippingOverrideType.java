...
@XmlType(name = "ShippingOverrideType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
...
public class ShippingOverrideType {
    ...
    @XmlElement(name = "DispatchTimeMaxOverride", namespace = "urn:ebay:apis:eBLBaseComponents")
