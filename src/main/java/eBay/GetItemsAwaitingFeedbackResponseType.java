...
@XmlType(name = "GetItemsAwaitingFeedbackResponseType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    ...
    extends AbstractResponseType
{
    ...
    @XmlElement(name = "ItemsAwaitingFeedback", namespace = "urn:ebay:apis:eBLBaseComponents")
