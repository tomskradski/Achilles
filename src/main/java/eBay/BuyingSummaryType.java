...
@XmlType(name = "BuyingSummaryType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "biddingCount",
    "winningCount",
    "totalWinningCost",
    "wonCount",
...
public class BuyingSummaryType {
    ...
    @XmlElement(name = "BiddingCount", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer biddingCount;
    @XmlElement(name = "WinningCount", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer winningCount;
    @XmlElement(name = "TotalWinningCost", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected AmountType totalWinningCost;
    @XmlElement(name = "WonCount", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer wonCount;
    @XmlElement(name = "TotalWonCost", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected AmountType totalWonCost;
    @XmlElement(name = "WonDurationInDays", namespace = "urn:ebay:apis:eBLBaseComponents")
