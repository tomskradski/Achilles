...
@XmlType(name = "GetBestOffersResponseType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "bestOfferArray",
    "item",
    "itemBestOffersArray",
    "pageNumber",
    ...
    extends AbstractResponseType
{
    ...
    @XmlElement(name = "ItemBestOffersArray", namespace = "urn:ebay:apis:eBLBaseComponents")
