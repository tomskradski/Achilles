...
@XmlType(name = "AddSellingManagerInventoryFolderRequestType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "folderName",
    "parentFolderID",
    "comment"
})
    ...
    extends AbstractRequestType
{
    ...
    @XmlElement(name = "Comment", namespace = "urn:ebay:apis:eBLBaseComponents")
