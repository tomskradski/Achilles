...
@XmlType(name = "GetMessagePreferencesResponseType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "asqPreferences"
})
    ...
    extends AbstractResponseType
{
    ...
    @XmlElement(name = "ASQPreferences", namespace = "urn:ebay:apis:eBLBaseComponents")
