 ...
 * 
 */
@XmlType(name = "FeatureIDCodeType", namespace = "urn:ebay:apis:eBLBaseComponents")
@XmlEnum
public enum FeatureIDCodeType {
    ...
    /**
     * 
     * 						If this value is specified, the <b>SiteDefaults.ProductCreationEnabled</b> and <b>Category.ProductCreationEnabled</b> fields in the <b>GetCategoryFeatures</b> response will indicate if the eBay site and individual categories support (and even require) the use of creating a listing through a product ID and leveraging the defined values/settings of an eBay Catalog product.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						If this value is specified, the <b>Category.PickupDropOffEnabled</b> fields in the <b>GetCategoryFeatures</b> response will indicate that items listed in the corresponding category may be enabled with the 'Click and Collect' feature. With the 'Click and Collect' feature, a buyer can purchase certain items on eBay and collect them at a local store. Buyers are notified by eBay once their items are available. A <code>false</code> value in this field indicates that items listed in the category are not eligible for the 'Click and Collect' feature.
     * 						<br/><br/>
     * 						The 'Click and Collect' feature is only available to large merchants on the eBay UK (site ID - 3) and eBay Australia (Site ID - 15) sites.
     * 					
     * 
     */
     ...
     * 						
     * <pre>
     * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;br xmlns="urn:ebay:apis:eBLBaseComponents" xmlns:ns="urn:ebay:apis:eBLBaseComponents" xmlns:xs="http://www.w3.org/2001/XMLSchema"/&gt;
     * </pre>
     * 
     * 						<ul>
