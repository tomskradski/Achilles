...
@XmlType(name = "GetMessagePreferencesRequestType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "sellerID",
    ...
    extends AbstractRequestType
{
    ...
    @XmlElement(name = "IncludeASQPreferences", namespace = "urn:ebay:apis:eBLBaseComponents")
