...
@XmlType(name = "GetSuggestedCategoriesResponseType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    ...
    extends AbstractResponseType
{
    ...
    @XmlElement(name = "SuggestedCategoryArray", namespace = "urn:ebay:apis:eBLBaseComponents")
