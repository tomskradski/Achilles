...
@XmlType(name = "DateType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "year",
    "month",
    "day"
})
public class DateType {
    ...
    @XmlElement(name = "Year", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer year;
    @XmlElement(name = "Month", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer month;
    @XmlElement(name = "Day", namespace = "urn:ebay:apis:eBLBaseComponents")
