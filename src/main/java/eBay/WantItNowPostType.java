...
@XmlType(name = "WantItNowPostType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "categoryID",
    "description",
    "postID",
    "site",
...
public class WantItNowPostType {
    ...
    @XmlElement(name = "PostID", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "ResponseCount", namespace = "urn:ebay:apis:eBLBaseComponents")
