...
@XmlType(name = "RemindersType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "paymentToSendCount",
...
public class RemindersType {
    ...
    @XmlElement(name = "PaymentToSendCount", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer paymentToSendCount;
    @XmlElement(name = "FeedbackToReceiveCount", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer feedbackToReceiveCount;
    @XmlElement(name = "FeedbackToSendCount", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer feedbackToSendCount;
    @XmlElement(name = "OutbidCount", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer outbidCount;
    @XmlElement(name = "PaymentToReceiveCount", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer paymentToReceiveCount;
    @XmlElement(name = "SecondChanceOfferCount", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer secondChanceOfferCount;
    @XmlElement(name = "ShippingNeededCount", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer shippingNeededCount;
    @XmlElement(name = "RelistingNeededCount", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer relistingNeededCount;
    @XmlElement(name = "TotalNewLeadsCount", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer totalNewLeadsCount;
    @XmlElement(name = "DocsForCCProcessingToSendCount", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer docsForCCProcessingToSendCount;
    @XmlElement(name = "RTEToProcessCount", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer rteToProcessCount;
    @XmlElement(name = "ItemReceiptToConfirmCount", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer itemReceiptToConfirmCount;
    @XmlElement(name = "RefundOnHoldCount", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer refundOnHoldCount;
    @XmlElement(name = "RefundCancelledCount", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer refundCancelledCount;
    @XmlElement(name = "ShippingDetailsToBeProvidedCount", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer shippingDetailsToBeProvidedCount;
    @XmlElement(name = "ItemReceiptConfirmationToReceiveCount", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer itemReceiptConfirmationToReceiveCount;
    @XmlElement(name = "RefundInitiatedCount", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer refundInitiatedCount;
    @XmlElement(name = "PendingRTERequestCount", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer pendingRTERequestCount;
    @XmlElement(name = "DeclinedRTERequestCount", namespace = "urn:ebay:apis:eBLBaseComponents")
