...
@XmlType(name = "GetAllBiddersResponseType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "bidArray",
    "highBidder",
    "highestBid",
    "listingStatus"
    ...
    extends AbstractResponseType
{
    ...
    @XmlElement(name = "BidArray", namespace = "urn:ebay:apis:eBLBaseComponents")
