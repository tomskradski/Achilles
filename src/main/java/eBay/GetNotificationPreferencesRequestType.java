...
@XmlType(name = "GetNotificationPreferencesRequestType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "preferenceLevel"
})
    ...
    extends AbstractRequestType
{
    ...
    @XmlElement(name = "PreferenceLevel", namespace = "urn:ebay:apis:eBLBaseComponents")
