...
@XmlType(name = "UploadSiteHostedPicturesResponseType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    ...
    extends AbstractResponseType
{
    ...
    @XmlElement(name = "SiteHostedPictureDetails", namespace = "urn:ebay:apis:eBLBaseComponents")
