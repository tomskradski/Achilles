...
@XmlType(name = "GetCharitiesRequestType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "charityID",
    "charityName",
    "query",
    "charityRegion",
    ...
    extends AbstractRequestType
{
    ...
    @XmlElement(name = "CharityDomain", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer charityDomain;
    @XmlElement(name = "IncludeDescription", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean includeDescription;
    @XmlElement(name = "MatchType", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "token")
    protected StringMatchCodeType matchType;
    @XmlElement(name = "Featured", namespace = "urn:ebay:apis:eBLBaseComponents")
