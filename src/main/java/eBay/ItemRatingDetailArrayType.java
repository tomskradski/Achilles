...
@XmlType(name = "ItemRatingDetailArrayType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "itemRatingDetails"
})
public class ItemRatingDetailArrayType {

    @XmlElement(name = "ItemRatingDetails", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected List<ItemRatingDetailsType> itemRatingDetails;

    /**
     * Gets the value of the itemRatingDetails property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the itemRatingDetails property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getItemRatingDetails().add(newItem);
     * </pre>
     * 
     * 
     * <p>
