...
public class AccountEntryType {
    ...
    @XmlElement(name = "AccountDetailsEntryType", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "GrossDetailAmount", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "ConversionRate", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected AmountType conversionRate;
    @XmlElement(name = "NetDetailAmount", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "ReceivedTopRatedDiscount", namespace = "urn:ebay:apis:eBLBaseComponents")
