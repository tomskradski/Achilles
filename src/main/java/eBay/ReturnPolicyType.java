...
@XmlType(name = "ReturnPolicyType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "refundOption",
    "refund",
    "returnsWithinOption",
    "returnsWithin",
...
public class ReturnPolicyType {
    ...
    @XmlElement(name = "RestockingFeeValueOption", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
    protected String restockingFeeValueOption;
    @XmlElement(name = "ExtendedHolidayReturns", namespace = "urn:ebay:apis:eBLBaseComponents")
