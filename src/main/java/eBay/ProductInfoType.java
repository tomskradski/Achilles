...
@XmlType(name = "ProductInfoType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "averageStartPrice",
    "averageSoldPrice",
    "title",
    "productState"
...
public class ProductInfoType {
    ...
    @XmlElement(name = "AverageStartPrice", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected AmountType averageStartPrice;
    @XmlElement(name = "AverageSoldPrice", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlAttribute(name = "productInfoID")
