...
@XmlType(name = "ProductType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "characteristicsSet",
    "detailsURL",
    "numItems",
    "minPrice",
...
public class ProductType {
    ...
    @XmlElement(name = "NumItems", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlAttribute(name = "stockPhotoURL")
    @XmlSchemaType(name = "anyURI")
