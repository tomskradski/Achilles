...
@XmlType(name = "GetVeROReasonCodeDetailsRequestType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "reasonCodeID",
    "returnAllSites"
})
    ...
    extends AbstractRequestType
{
    ...
    @XmlElement(name = "ReasonCodeID", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Long reasonCodeID;
    @XmlElement(name = "ReturnAllSites", namespace = "urn:ebay:apis:eBLBaseComponents")
