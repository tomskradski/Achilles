...
@XmlType(name = "VariationType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "sku",
    "startPrice",
    "quantity",
    "variationSpecifics",
...
public class VariationType {
    ...
    @XmlElement(name = "UnitsAvailable", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "VariationTitle", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected String variationTitle;
    @XmlElement(name = "VariationViewItemURL", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "anyURI")
    protected String variationViewItemURL;
    @XmlElement(name = "Delete", namespace = "urn:ebay:apis:eBLBaseComponents", defaultValue = "false")
    ...
    @XmlElement(name = "VariationProductListingDetails", namespace = "urn:ebay:apis:eBLBaseComponents")
