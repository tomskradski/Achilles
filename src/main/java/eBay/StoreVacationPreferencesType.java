...
@XmlType(name = "StoreVacationPreferencesType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "onVacation",
    "returnDate",
...
public class StoreVacationPreferencesType {
    ...
    @XmlElement(name = "OnVacation", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean onVacation;
    @XmlElement(name = "ReturnDate", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar returnDate;
    @XmlElement(name = "HideFixedPriceStoreItems", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean hideFixedPriceStoreItems;
    @XmlElement(name = "MessageItem", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean messageItem;
    @XmlElement(name = "MessageStore", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean messageStore;
    @XmlElement(name = "DisplayMessageStoreCustomText", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean displayMessageStoreCustomText;
    @XmlElement(name = "MessageStoreCustomText", namespace = "urn:ebay:apis:eBLBaseComponents")
