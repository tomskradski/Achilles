...
@XmlType(name = "MyeBaySellingSummaryType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "activeAuctionCount",
    "auctionSellingCount",
    "auctionBidCount",
...
public class MyeBaySellingSummaryType {
    ...
    @XmlElement(name = "ActiveAuctionCount", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer activeAuctionCount;
    @XmlElement(name = "AuctionSellingCount", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer auctionSellingCount;
    @XmlElement(name = "AuctionBidCount", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer auctionBidCount;
    @XmlElement(name = "TotalAuctionSellingValue", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected AmountType totalAuctionSellingValue;
    @XmlElement(name = "TotalSoldCount", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer totalSoldCount;
    @XmlElement(name = "TotalSoldValue", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected AmountType totalSoldValue;
    @XmlElement(name = "SoldDurationInDays", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer soldDurationInDays;
    @XmlElement(name = "ClassifiedAdCount", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer classifiedAdCount;
    @XmlElement(name = "TotalLeadCount", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer totalLeadCount;
    @XmlElement(name = "ClassifiedAdOfferCount", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer classifiedAdOfferCount;
    @XmlElement(name = "TotalListingsWithLeads", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer totalListingsWithLeads;
    @XmlElement(name = "QuantityLimitRemaining", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Long quantityLimitRemaining;
    @XmlElement(name = "AmountLimitRemaining", namespace = "urn:ebay:apis:eBLBaseComponents")
