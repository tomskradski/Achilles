...
@XmlType(name = "GetAllBiddersRequestType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "itemID",
    "callMode",
    ...
    extends AbstractRequestType
{
    ...
    @XmlElement(name = "CallMode", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "token")
    protected GetAllBiddersModeCodeType callMode;
    @XmlElement(name = "IncludeBiddingSummary", namespace = "urn:ebay:apis:eBLBaseComponents")
