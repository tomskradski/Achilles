 ...
 * 			
 * 
 * <p>Java class for GetSellingManagerTemplateAutomationRuleResponseType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="GetSellingManagerTemplateAutomationRuleResponseType">
 *   &lt;complexContent>
...
@XmlType(name = "GetSellingManagerTemplateAutomationRuleResponseType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "automatedListingRule",
    "automatedRelistingRule",
    "automatedSecondChanceOfferRule",
    "fees"
})
public class GetSellingManagerTemplateAutomationRuleResponseType
    extends AbstractResponseType
{

    @XmlElement(name = "AutomatedListingRule", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected SellingManagerAutoListType automatedListingRule;
    @XmlElement(name = "AutomatedRelistingRule", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected SellingManagerAutoRelistType automatedRelistingRule;
    @XmlElement(name = "AutomatedSecondChanceOfferRule", namespace = "urn:ebay:apis:eBLBaseComponents")
