...
@XmlType(name = "ReviseCheckoutStatusRequestType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "itemID",
    "transactionID",
    "orderID",
    "amountPaid",
    ...
    extends AbstractRequestType
{
    ...
    @XmlElement(name = "CheckoutMethod", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "token")
    protected CheckoutMethodCodeType checkoutMethod;
    @XmlElement(name = "InsuranceType", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "token")
    ...
    @XmlElement(name = "EncryptedID", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "MultipleSellerPaymentID", namespace = "urn:ebay:apis:eBLBaseComponents")
