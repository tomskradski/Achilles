...
@XmlType(name = "MessageMediaType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "mediaURL",
    "mediaName"
})
public class MessageMediaType {

    @XmlElement(name = "MediaURL", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "anyURI")
    protected String mediaURL;
    @XmlElement(name = "MediaName", namespace = "urn:ebay:apis:eBLBaseComponents")
