...
/**
 * 
 * 				Indicates the refund amount that a seller issued to a buyer for a single Half.com order line item. Refunds may only be issued for a specific order line item. Sellers do not have the ability to issue a general refund (not tied to an order line item) to a buyer.
 * 			
 * 
...
@XmlType(name = "IssueRefundResponseType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "refundFromSeller",
    "totalRefundToBuyer"
})
