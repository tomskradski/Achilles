...
@XmlType(name = "RemoveFromWatchListResponseType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "watchListCount",
    "watchListMaximum"
})
    ...
    extends AbstractResponseType
{
    ...
    @XmlElement(name = "WatchListCount", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer watchListCount;
    @XmlElement(name = "WatchListMaximum", namespace = "urn:ebay:apis:eBLBaseComponents")
