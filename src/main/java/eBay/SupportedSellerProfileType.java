...
@XmlType(name = "SupportedSellerProfileType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "profileID",
    "profileType",
    "profileName",
    "shortSummary",
...
public class SupportedSellerProfileType {
    ...
    @XmlElement(name = "ProfileID", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Long profileID;
    @XmlElement(name = "ProfileType", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected String profileType;
    @XmlElement(name = "ProfileName", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected String profileName;
    @XmlElement(name = "ShortSummary", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected String shortSummary;
    @XmlElement(name = "CategoryGroup", namespace = "urn:ebay:apis:eBLBaseComponents")
