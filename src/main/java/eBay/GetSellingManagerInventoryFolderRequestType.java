...
@XmlType(name = "GetSellingManagerInventoryFolderRequestType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "folderID",
    "maxDepth",
    "fullRecursion"
})
    ...
    extends AbstractRequestType
{
    ...
    @XmlElement(name = "MaxDepth", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Integer maxDepth;
    @XmlElement(name = "FullRecursion", namespace = "urn:ebay:apis:eBLBaseComponents")
