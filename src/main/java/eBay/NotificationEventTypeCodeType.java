 ...
 * 
 */
@XmlType(name = "NotificationEventTypeCodeType", namespace = "urn:ebay:apis:eBLBaseComponents")
@XmlEnum
public enum NotificationEventTypeCodeType {
    ...
    /**
     * 
     *             This notification is sent to a subscribed seller if an eBay courier has picked up an eBay Scheduled Delivery order from a store for delivery to a buyer. This notification is only applicable for eBay Scheduled Delivery orders, which are only available in the London (UK) area.
     * 					
     * 
     */
    ...
    /**
     * 
     *             This notification is sent to a subscribed seller if an eBay Scheduled Delivery order has been cancelled. This notification is only applicable for eBay Scheduled Delivery orders, which are only available in the London (UK) area.
     * 					
     * 
     */
