...
@XmlType(name = "GetStoreCustomPageResponseType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "customPageArray"
})
    ...
    extends AbstractResponseType
{
    ...
    @XmlElement(name = "CustomPageArray", namespace = "urn:ebay:apis:eBLBaseComponents")
