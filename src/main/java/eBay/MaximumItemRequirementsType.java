...
@XmlType(name = "MaximumItemRequirementsType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "maximumItemCount",
    "minimumFeedbackScore"
})
public class MaximumItemRequirementsType {

    @XmlElement(name = "MaximumItemCount", namespace = "urn:ebay:apis:eBLBaseComponents")
