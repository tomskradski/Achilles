...
@XmlType(name = "BusinessSellerDetailsType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "address",
    "fax",
    "email",
...
public class BusinessSellerDetailsType {
    ...
    @XmlElement(name = "Fax", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected String fax;
    @XmlElement(name = "Email", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected String email;
    @XmlElement(name = "AdditionalContactInformation", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected String additionalContactInformation;
    @XmlElement(name = "TradeRegistrationNumber", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected String tradeRegistrationNumber;
    @XmlElement(name = "LegalInvoice", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean legalInvoice;
    @XmlElement(name = "TermsAndConditions", namespace = "urn:ebay:apis:eBLBaseComponents")
