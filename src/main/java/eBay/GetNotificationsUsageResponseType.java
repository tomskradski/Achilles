...
@XmlType(name = "GetNotificationsUsageResponseType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "startTime",
    "endTime",
    ...
    extends AbstractResponseType
{
    ...
    @XmlElement(name = "NotificationDetailsArray", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected NotificationDetailsArrayType notificationDetailsArray;
    @XmlElement(name = "MarkUpMarkDownHistory", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected MarkUpMarkDownHistoryType markUpMarkDownHistory;
    @XmlElement(name = "NotificationStatistics", namespace = "urn:ebay:apis:eBLBaseComponents")
