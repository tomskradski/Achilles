...
@XmlType(name = "SaveItemToSellingManagerTemplateRequestType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "itemID",
    "productID",
    "templateName"
})
    ...
    extends AbstractRequestType
{
    ...
    @XmlElement(name = "TemplateName", namespace = "urn:ebay:apis:eBLBaseComponents")
