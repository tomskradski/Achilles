...
@XmlType(name = "MyMessagesMessageType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
    "sender",
    "recipientUserID",
    "sendToName",
    "subject",
...
public class MyMessagesMessageType {
    ...
    @XmlElement(name = "SendToName", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "Flagged", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "Replied", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean replied;
    @XmlElement(name = "HighPriority", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected Boolean highPriority;
    @XmlElement(name = "ItemEndTime", namespace = "urn:ebay:apis:eBLBaseComponents")
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar itemEndTime;
     ...
     *     
     */
    public XMLGregorianCalendar getItemEndTime() {
        return itemEndTime;
    }
     ...
     *     
     */
    public void setItemEndTime(XMLGregorianCalendar value) {
